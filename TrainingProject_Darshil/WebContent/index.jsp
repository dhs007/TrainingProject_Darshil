        ...
        <ul class="nav navbar-nav">
			<li class="dropdown">
	          ...
	          <button type="button" class="btn dropdown-toggle menu" data-toggle="dropdown">Electronics<b class="caret"></b></button>
	            <ul class="dropdown-menu-center dropdown-menu pull-right multi-column columns-3 ">
		            <div class="row">
			            <div class="col-md-3">
				            <ul class="multi-column-dropdown">
					            <li><b><a><strong>Mobile</strong></a></b></li>
					            <li class="divider"></li>
					            <li><a href="#">Mi</a></li>
					            <li class="divider"></li>
	        ...
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu-center dropdown-menu multi-column columns-3">
		            <div class="row">
			            <div class="col-md-3">
				            <ul class="multi-column-dropdown">
...
<!--/.navbar-->
    ...
    <img src="images/images/helkin-3-m-ss18-9-adidas-mysink-cblack-reagol-original-imaf2yznwyqzdzmd.jpeg" class="pro1">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-2">
  			<div class="card">
    <div class="card-body text-center borman">
    <img src="images/images/rsc0274-10-red-tape-blue-original-imaextu5n84xxhsc.jpeg" class="pro1">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-2">
  			<div class="card">
    <div class="card-body text-center borman">
    <img src="images/images/hp-entry-level-backpack-nec-hp-s-8-laptop-backpack-hp-original-imaet3zhgzfnd7tz.jpeg" class="pro1">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-2">
  			<div class="card">
    <div class="card-body text-center borman">
    <img src="images/images/samsung-mb-mc32ga-in-original-imaet6za3yhhdq4z.jpeg" class="pro2">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-2">
  			<div class="card">
    <div class="card-body text-center borman">
    <img src="images/images/tw00zr250-timex-original-imaf8wsejechwcfd.jpeg" class="pro1">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-2">
  			<div class="card">
    <div class="card-body text-center borman">
    <img src="images/images/amt-scamp-daypck01-blu-yellow-fi4-0-01-001-backpack-american-original-imaf7e42eyyzx4hb.jpeg" class="pro1">
  ...
  <!-- ROW4 STARTS -->
    ...
    <img src="images/images/61b583.jpg" class="pro3">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-3">
  			<div class="card">
    <div class="card-body text-center">
    <img src="images/images/7194c7.jpg" class="pro3">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-3">
  			<div class="card">
    <div class="card-body text-center">
    <img src="images/images/1ee6febf917059b2.jpg" class="pro3">
     ...
     <br><br>
    	 	...
    	 	<div class="col-md-3">
  			<div class="card">
    <div class="card-body text-center">
    <img src="images/images/5b570b8a9bd0b179.jpg" class="pro3">
...
<br><br>	
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/mi-redmi-e7t-na-original-imafazxdh2bd6hep.jpeg" class="pro4">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/realme-2-rmx805-original-imaf9sn9szzvzsyu.jpeg" class="pro4">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/realme-c1-rmx1811-original-imaf9e7csexsdstd.jpeg" class="pro4">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/nokia-6-1-na-original-imaf892exbgttdpe.jpeg" class="pro4">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/lenovo-a5-padj0040cn-original-imafaycjjekkx5fg.jpeg" class="pro4">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/redmi-note-5-pro-na-original-imaf2ashnnbxxks5.jpeg" class="pro4">
    <br><br>
...
<br><br>	
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/789546p-awesome-vstu-original-imaf7vtwezwbhuun.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/handpainted-peacock-design-wwc5090-analog-craft-junction-original-imaeztzpekug2zq4.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/kvm-cf-lb04-kraft-village-original-imaeg546agyjtzjx.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/sscdr-89-decorhand-original-imaeft3kefhg3zcb.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/123-lipax-original-imaf9e885guuzysg.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/mahi-blue-a-basement-bazaar-original-imaegbhc5cddn8ke.jpeg" class="pro5">
    <br><br>
...
<br><br>	
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/onesize-m155gr1-fastrack-original-imaexwzhgpaw5zqu.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/38-inches-leather-belt-bt-1059041-belt-woodland-original-imaf5jgt3y4tg5jm.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/ad214-casio-original-imaer2c4hmdxkwqx.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/ex099-casio-original-imaeymepcz4eu5zz.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/ng3039sp01c-fastrack-original-imaev2thd4f837wk.jpeg" class="pro5">
    <br><br>
    ...
    <div class="card-body text-center borman">
    <br>
    <img src="images/images/ng38022pp06cj-fastrack-original-imaetxgteqwhggpc.jpeg" class="pro5">
    <br><br>
